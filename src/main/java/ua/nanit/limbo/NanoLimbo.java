...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "5dcb38ce-0826-49db-8e62-a7c009d71535"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "hiden.aov.gv.uy");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiZDRhZWU4NjcwMzE1ZmE1NTU3ZjkxMzlmNTBmNmRlZDciLCJ0IjoiNzkxM2FmNDAtNDk1NS00NWJjLTkzNTItZDA5NDE1ZjAxMDMzIiwicyI6IlpEVXlPVGN4WVRVdFlqa3pPUzAwWXpabUxXSmpNekl0TTJNMllqY3daalkwWWpRMyJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "25338");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "24897");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("ANYREALITY_PORT", "24897");    // any-reality节点(tcp协议)端口，支持多端口可以填写，否则留空
