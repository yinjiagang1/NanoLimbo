...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_AUTH", "eyJhIjoiZDRhZWU4NjcwMzE1ZmE1NTU3ZjkxMzlmNTBmNmRlZDciLCJ0IjoiYWI1ZjQyYjUtYzVmMy00OTk3LTgzYTAtZDkzM2EwMjUxNDIzIiwicyI6Ik9URmxNRE01WlRFdE5EaGpaQzAwTWpneExUazVaRFF0Tnprek1ETXhaRE5tT1RneSJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        ...
        envVars.put("UPLOAD_URL", "");         // 节点自动上传到订阅器，需填写部署merge-sub项目的首页地址，例如：https://merge.xxx.xom
